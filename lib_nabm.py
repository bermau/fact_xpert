...
# Pour nouvelle NABM indiquer :

dates_of_nabm_changes =  {num:("nabm"+str(num),"incompatibility"+str(num))  for num in range(Cf.first_nabm, Cf.last_nabm + 1 +1)}
...
"""
    ...
    return dates_of_nabm_changes[int(nabm_version)]
...
##        pass
    ...
    def describe_nabm_code(self, code= "0126"):
        """Describe an NABM code.
        code : int or str
        """

        req = """SELECT * from nabm WHERE code = "0126" """
        self.NABM_DB.quick_sql(req)
