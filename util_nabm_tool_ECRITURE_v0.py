...
def creer_fichier_incompatibilites(path_to_file, path_to_output):
    """Creation du CSV des incompatibilités de la NABM.
Ce fichier est créé pour être intgré dans la base sqlite."""
    pass
                    
def creer_fichier_nabm(path_to_file, path_to_output):
...
def _creer_fichier_nabm(num= nabm_version):
    ...
    creer_fichier_nabm(path_to_file, path_to_output)

def _creer_fichier_incomp(num=nabm_version):
...
class Menu():
    ...
    lst_menu = [
        ["1", "saisir séquence d'actes", lancer1],
        ["2", "Décrire un code", describe_a_code],
        ...
        ["CNABM", "Créer Fichier CSV pour NABM", _creer_fichier_nabm],
        ["CINC", "Créer Fichier CSV pour incompatibilité", _creer_fichier_incomp],
        ["Q", "Quitter", quitter],
                ]
